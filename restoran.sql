...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 27 Jun 2022 pada 02.58
-- Versi server: 5.7.36
-- Versi PHP: 7.4.26
...
CREATE TABLE IF NOT EXISTS `meja` (
  ...
  `status_meja` enum('Kosong','Terisi') COLLATE utf8_unicode_ci DEFAULT 'Kosong',
  PRIMARY KEY (`no_meja`)
...
INSERT INTO `meja` (`no_meja`, `meja`, `status_meja`) VALUES
(1, 1, 'Kosong'),
(2, 2, 'Kosong'),
(3, 3, 'Kosong'),
(4, 4, 'Kosong'),
...
('KOK001', 'Juna', 'Koki', 'Laki-laki', 'koki', 'koki'),
('KSR001', 'Yuda', 'Kasir', 'Laki-laki', 'kasir', 'kasir'),
('PYN001', 'Lutfi', 'Pelayan', 'Laki-laki', 'pelayan', 'pelayan');
