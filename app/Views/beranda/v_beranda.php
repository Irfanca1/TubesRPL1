                        ...
                        <?php if (!is_kasir()) : ?>
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-warning">
                                    <div class="inner">
                                        <h3 class="text-light"><?= $menuTersedia; ?></h3>
                                        <p class="text-light">Menu Tersedia</p>
                                    </div>
                                    <div class="icon">
                                        <i class="ion ion-spoon"></i>
                                    </div>
                                    <a href="<?= base_url('/menu') ?>" class="small-box-footer" style="color: #fff !important;"> Lihat <i class="fas fa-arrow-circle-right text-light"></i></a>
                                </div>
                            <?php endif; ?>
