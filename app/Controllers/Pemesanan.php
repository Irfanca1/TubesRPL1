...
class Pemesanan extends BaseController
{
    ...
    public function create()
    {
        ...
        // Update status_meja menjadi 'Terisi' berdasarkan no_meja yang dipesan
        ...
        for ($i = 0; $i < count($nama_menu); $i++) {
            // Ambil stok menu berdasarkan nama menu, kurangi dengan jumlah yang dipesan
            ...
            // Get harga menu berdasarkan nama_menu, hitung subtotal dari harga * kuantitas
        ...
        // Get total_harga berdasarkan no_pemesanan. Hitung pajak dan total bayar
        ...
        session()->setFlashdata('pesan', 'Pemesanan Berhasil');
